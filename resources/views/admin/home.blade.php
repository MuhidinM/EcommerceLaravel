                        ...
                        <div class="flex flex-wrap -m-4 text-center">
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                    <img src="https://img.icons8.com/windows/96/4a90e2/store-front.png"
                                        class="text-indigo-500 w-12 h-12 mb-3 inline-block" alt="shop">
                                    <h2 class="title-font font-medium text-3xl text-gray-900">{{ $stores }}</h2>
                                    <p class="leading-relaxed">Stores</p>
                                </div>
                            </div>
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                    <img src="https://img.icons8.com/ios-glyphs/90/4a90e2/group.png"
                                        class="text-indigo-500 w-12 h-12 mb-3 inline-block" alt="users" />
